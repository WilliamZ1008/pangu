"""
Parallel wrapper around the shared offline experiment runner.
"""
import argparse
import json
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run an offline EduBench experiment with thread-level parallelism.")
